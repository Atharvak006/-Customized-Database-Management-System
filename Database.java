...
class DBMS
{
    ...
    //update student set city = '____' where Rno = _____;    public void SelectStarFromName(String str)
...
class Database
{
    public static void main(String Arg[])
    {
        ...
        obj.InsertIntoTable("Rukmini","Kolhapur",75);
        obj.SelectStarFrom();
...
10 : update student set city = '____' where Rno = _____;
